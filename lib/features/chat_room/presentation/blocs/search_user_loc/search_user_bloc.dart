...
class SearchUserBloc extends Bloc<SearchEvent, SearchUserState> {
 ...
 // StreamSubscription? searchUser;
  ...
  Stream<SearchUserState> _mapAddChatRoomState(UserModel user,
      UserModel friendModel,String title) async* {
    yield SearchUserStateLoading();
    String chatRoomId = await _chatService.addChatRoom(user, friendModel,title);
