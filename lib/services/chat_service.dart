...
class   ChatService {
  ...
  Future<String> addChatRoom(UserModel user, UserModel friendUser,String roomName) async {
  ...
  StreamTransformer<QuerySnapshot<Map<String, dynamic>>, List<ChatMessage>> documentToChatMessagesTransformer = StreamTransformer<
      QuerySnapshot<Map<String, dynamic>>,
      List<ChatMessage>>.fromHandlers(
      handleData: (QuerySnapshot<Map<String, dynamic>> snapShot, EventSink<List<ChatMessage>> sink) {
  ...
  Future<Map<String,dynamic>?> sendChatMessage(String chatRoomId, ChatMessage chatMessage) async {
    return await _repository.sendChatMessage(chatRoomId, chatMessage);
  }

  Future<Map<String,dynamic>?> setChatRoomLastMessage(String chatRoomId, ChatMessage chatMessage) async {
