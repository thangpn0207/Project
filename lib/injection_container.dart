...
void _configureCubit() {
  ...
  inject.registerFactory(
      () => SignUpCubit(inject(), inject(), inject(), inject()));
  inject.registerFactory(
      () => ChangePasswordCubit(inject(), inject(), inject(), inject()));
  ...
  inject.registerLazySingleton(
      () => UploadAvatarCubit(inject(), inject(), inject()));
  inject.registerLazySingleton(
      () => UpdateInfoCubit(inject(), inject(), inject(), inject()));
